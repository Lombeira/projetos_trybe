...
describe('9 - Implemente os casos de teste para a função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    assert.deepStrictEqual(Object.entries(getCharacter('Arya')), [
      ['name', 'Arya Stark'],
      ['class', 'Rogue'],
      ['phrases', ['Not today', 'A girl has no name.']],
    ]);
    // Teste se a função retorna o objeto correto para o parâmetro 'Brienne',
    assert.deepStrictEqual(Object.entries(getCharacter('Brienne')), [
      ['name', 'Brienne Tarth'],
      ['class', 'Knight'],
      [
        'phrases',
    ...
    assert.deepStrictEqual(Object.entries(getCharacter('Melissandre')), [
      ['name', 'Melissandre'],
      ['class', 'Necromancer'],
      [
        'phrases',
